...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='labelcomponent']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"labelcomponent","hydrated",[["label-component","label-component",1,[["description",1,0,1,2],["title",1,0,1,2]],1]]);