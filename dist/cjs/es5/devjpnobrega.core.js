...
} var s = e.namespace || "devJpnobrega"; return L || (L = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.Y || 1 === r.Y && !t.J.Z) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
...
} return !0; }, P = function (n, t, e, r, i, o) { if (n.wn.delete(t), (i = n.jn.get(t)) && ((r = i["s-ld"]) && ((e = r.indexOf(t)) > -1 && r.splice(e, 1), r.length || i["s-init"] && i["s-init"]()), n.jn.delete(t)), n.Rn.length && !n.wn.size)
    for (; o = n.Rn.shift();)
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Ln = !0; } }));
        ...
        catch (n) { } return 1 === t.Y && n.Z && !e.shadowRoot && n.it(e, { mode: "open" }), r = { Wn: {} }, t.en && Object.keys(t.en).forEach(function (o) { (i = t.en[o].fn) && (r.Wn[i] = n.Kn(e, i)); }), r; }(n.J, t, e)), n.at(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { !n.st && function (n, t) { for (; t;) {
        if (!n.Gn(t))
            return 9 !== n.Dn(t);
        t = n.Gn(t);
    } }(n.J, t) && (n.gn.set(t, !0), P(n, t), M(n.On.get(t), !0), n.J.un(t), n.ot.delete(t), n.l && n.l.removeHost(t), [n.jn, n.lt, n.kn].forEach(function (n) { return n.delete(t); })); })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o, u) { if (x(n, t) && (i = n.Mn.get(t)) && !n.gn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ct.set(t, !0), (u = n.vt.has(t)) || (n.vt.set(t, !0), t["s-ld"] = void 0, n.J.Cn(t, e));
        try {
            M(n.On.get(t)), (o = n.lt.get(t)) && (o.forEach(function (n) { return n(t); }), n.lt.delete(t)), !u && i.componentDidLoad && i.componentDidLoad();
        }
        catch (e) {
            n.$n(e, 4, t);
        }
    ...
    } S(b, t, f); }); }, Sn: !1, mn: !1, st: !1, En: l, jn: new WeakMap, V: new WeakMap, Nn: new WeakMap, ot: new WeakMap, vt: new WeakMap, ct: new WeakMap, Tn: new WeakMap, kn: new WeakMap, Mn: new WeakMap, gn: new WeakMap, bn: new WeakMap, lt: new WeakMap, Pn: new WeakMap, On: new WeakMap, _n: new WeakMap, wn: new Set, Rn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, t.enableListener = function (n, t, e, r, i) { return function o(n, t, e, r, i, u) { if (t) {
    ...
    if (c && c.ln)
        if (r) {
            ...
            n.J.un(f, e, 1);
} }(b, n, t, e, r, i); }, b.xn = t.emit = function (n, e, r) { return h.et(n, t.eventNameFn ? t.eventNameFn(e) : e, r); }, d.h = e, d.Context = t, d.onReady = function () { return new Promise(function (n) { return b.queue.write(function () { return b.wn.size ? b.Rn.push(n) : n(); }); }); }, b.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, l, p, d, h, y, w, b, M) { if (b = l.vchildren[p], e || (o = !0, "slot" === b.vtag && (r && t.Cn(d, r + "-s"), b.vchildren ? b.dt = !0 : b.ht = !0)), v(b.vtext))
    b.i = t.Hn(b.vtext);
else if (b.ht)
    b.i = t.Hn("");
else {
    if (y = b.i = g || "svg" === b.vtag ? t.Fn("http://www.w3.org/2000/svg", b.vtag) : t.X(b.dt ? "slot-fb" : b.vtag), n.ft(y) && n.ct.delete(c), g = "svg" === b.vtag || "foreignObject" !== b.vtag && g, m(n, null, b, g), v(r) && y["s-si"] !== r && t.Cn(y, y["s-si"] = r), b.vchildren)
        for (h = 0; h < b.vchildren.length; ++h)
            (w = a(i, b, h, y)) && t.Bn(y, w);
    "svg" === b.vtag && (g = !1);
} return b.i["s-hn"] = f, (b.dt || b.ht) && (b.i["s-sr"] = !0, b.i["s-cr"] = u, b.i["s-sn"] = b.vname || "", (M = i && i.vchildren && i.vchildren[p]) && M.vtag === b.vtag && i.i && s(i.i)), b.i; }, s = function (e, r, i, u) { n.st = !0; var c = t.In(e); for (i = c.length - 1; i >= 0; i--)
    ...
    if (null == M)
        ...
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.Gn(M.i)), w(M, A), t.nn(n, M.i, t.Qn(j.i)), M = e[++b], A = i[--k];
    else if (d(j, $))
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.Gn(j.i)), w(j, $), t.nn(n, j.i, M.i), j = e[--g], $ = i[++m];
    else {
    ...
    } b > g ? l(n, null == i[k + 1] ? null : i[k + 1].i, r, i, m, k) : m > k && p(e, b, g); }(o, u, r, f) : v(f) ? (v(e.vtext) && t.Jn(o, ""), l(o, null, r, f, 0, f.length - 1)) : v(u) && p(u, 0, u.length - 1)), g && "svg" === r.vtag && (g = !1); }, b = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.In(n)).length; i < o; i++)
    if (e = r[i], 1 === t.Dn(e)) {
        if (e["s-sr"])
    ...
    if ((r = e[u])["s-sr"] && (o = r["s-cr"]))
        for (a = t.In(t.Gn(o)), s = r["s-sn"], c = a.length - 1; c >= 0; c--)
            (o = a[c])["s-cn"] || o["s-nr"] || o["s-hn"] === r["s-hn"] || ((3 === (l = t.Dn(o)) || 8 === l) && "" === s || 1 === l && null === t.Kn(o, "slot") && "" === s || 1 === l && t.Kn(o, "slot") === s) && (M.some(function (n) { return n.yt === o; }) || (i = !0, o["s-sn"] = s, M.push({ wt: r, yt: o })));
    1 === t.Dn(r) && j(r);
} }; return function (a, s, l, v, p, d, h, y, m, g, k, $) { if (c = a, f = t.Zn(c), u = c["s-cr"], e = v, r = c["s-sc"], o = i = !1, w(s, l), o) {
    for (j(l.i), h = 0; h < M.length; h++)
        (y = M[h]).yt["s-ol"] || ((m = t.Hn(""))["s-nr"] = y.yt, t.nn(t.Gn(y.yt), y.yt["s-ol"] = m, y.yt));
    for (n.st = !0, h = 0; h < M.length; h++) {
        for (y = M[h], k = t.Gn(y.wt), $ = t.Qn(y.wt), m = y.yt["s-ol"]; m = t.Yn(m);)
            if ((g = m["s-nr"]) && g && g["s-sn"] === y.yt["s-sn"] && k === t.Gn(g) && (g = t.Qn(g)) && g && !g["s-nr"]) {
                $ = g;
                break;
            }
    ...
    n.st = !1;
} return i && b(l.i), M.length = 0, l; }; }(b, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { b.ct.set(y, d.loaded = b.mn = !0), h.et(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
